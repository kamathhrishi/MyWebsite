...
<p>
Although the scheme is very secure. It is practically not usable. The reasons will motivate further crypto algorithms that I will be introducing. Here are some reasons why above algorithm cannot be used in practical settings:
<ul>
